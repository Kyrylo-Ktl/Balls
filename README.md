...
## Ball moving
To move the ball, it is necessary to recalculate the coordinates and accelerations along the ```math x``` and $y$ axes in $t$ seconds using the following formulas:\
\
